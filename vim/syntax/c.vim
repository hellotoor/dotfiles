...
"========================================================
"syn match cFuntions display "/<[a-zA-Z_][a-zA-Z_0-9]*/>[^()]*)("me=e-2
"syn match cFuntions display "/<[a-zA-Z_][a-zA-Z_0-9]*/>/s*("me=e-1
"hi cFunction cterm=bold ctermfg=4 ctermbg=0
